...
<required_reading>
@/home/arkrly/Projects/msb-ecom/.opencode/gsd-core/references/ai-frameworks.md
@/home/arkrly/Projects/msb-ecom/.opencode/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/arkrly/Projects/msb-ecom/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/arkrly/Projects/msb-ecom/.opencode/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/arkrly/Projects/msb-ecom/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/arkrly/Projects/msb-ecom/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/arkrly/Projects/msb-ecom/.opencode/agents/gsd-eval-planner.md for instructions.
