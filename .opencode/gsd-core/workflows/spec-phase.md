...
ones). Reference: @/home/arkrly/Projects/msb-ecom/.opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/arkrly/Projects/msb-ecom/.opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/arkrly/Projects/msb-ecom/.opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/arkrly/Projects/msb-ecom/.opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/arkrly/Projects/msb-ecom/.opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/arkrly/Projects/msb-ecom/.opencode/gsd-core/templates/spec.md.
