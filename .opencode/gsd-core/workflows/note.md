...
- **Global scope**: `/home/arkrly/Projects/msb-ecom/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/arkrly/Projects/msb-ecom/.opencode/notes/`)
...
2. Glob `/home/arkrly/Projects/msb-ecom/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/arkrly/Projects/msb-ecom/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/arkrly/Projects/msb-ecom/.opencode/notes/` — works in any directory
