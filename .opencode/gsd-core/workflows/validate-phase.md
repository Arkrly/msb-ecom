...
```
Agent(
  prompt="Read /home/arkrly/Projects/msb-ecom/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/arkrly/Projects/msb-ecom/.opencode/gsd-core/templates/VALIDATION.md`
