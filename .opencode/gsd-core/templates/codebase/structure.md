...
- Usage: Reference from command with `@/home/arkrly/Projects/msb-ecom/.opencode/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/arkrly/Projects/msb-ecom/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/arkrly/Projects/msb-ecom/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
