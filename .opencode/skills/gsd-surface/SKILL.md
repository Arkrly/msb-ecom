...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/arkrly/Projects/msb-ecom/.opencode/.gsd-surface.json`
(sibling to `/home/arkrly/Projects/msb-ecom/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/arkrly/Projects/msb-ecom/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/home/arkrly/Projects/msb-ecom/.opencode/skills`).
...
`/home/arkrly/Projects/msb-ecom/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/arkrly/Projects/msb-ecom/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/arkrly/Projects/msb-ecom/.opencode/.gsd-surface.json`
Install profile marker: `/home/arkrly/Projects/msb-ecom/.opencode/.gsd-profile`
Skill dirs: `/home/arkrly/Projects/msb-ecom/.opencode/skills/gsd-*/`
Engine module: `/home/arkrly/Projects/msb-ecom/.opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/arkrly/Projects/msb-ecom/.opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
