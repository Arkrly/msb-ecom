...
## Corpus Check
- 318 files · ~812,058 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4137 nodes · 4709 edges · 280 communities (249 shown, 31 thin omitted)
...
1. `Communities (273 total, 26 thin omitted)` - 243 edges
...
- `SessionAuthenticationFilter` --references--> `UserRepository`  [EXTRACTED]
  auth-service/src/main/java/com/msb/ecom/auth_service/config/SessionAuthenticationFilter.java → auth-service/src/main/java/com/msb/ecom/auth_service/repository/UserRepository.java
...
- `OrderController` --references--> `OrderService`  [EXTRACTED]
  order-service/src/main/java/com/msb/ecom/order_service/controller/OrderController.java → order-service/src/main/java/com/msb/ecom/order_service/service/OrderService.java
...
Cohesion: 0.06
Nodes (31): ApiGatewayApplicationTests, LoginRequest, SignupRequest, AuthServiceApplicationTests, InventoryServiceApplicationTests, KafkaTemplate, OrderPlacedEvent, NotificationService (+23 more)
...
Cohesion: 0.11
Nodes (19): 1. The Mobile Performance Mindset, 5. Memory Management, 6. Battery Optimization, 7. Network Performance, 9. Quick Reference Card, Animation Targets, Background Task Guidelines, Battery Drain Sources (+11 more)
...
Cohesion: 0.16
Nodes (9): GetMapping, PostMapping, RequestMapping, ResponseStatus, RestController, OrderController, OrderRequest, OrderResponse (+1 more)
...
Cohesion: 0.15
Nodes (19): Inventory, Entity, Table, InventoryRepository, lombok.AllArgsConstructor, lombok.Builder, lombok.Data, lombok.NoArgsConstructor (+11 more)
...
### Community 39 - "Communities (273 total, 26 thin omitted)"
Cohesion: 0.01
Nodes (243): Communities (273 total, 26 thin omitted), Community 0 - "org.junit.jupiter.api.Test", Community 100 - "checklist.py", Community 101 - "app-builder/SKILL.md", Community 102 - "Antigravity Skills", Community 103 - "Mobile Game Development", Community 104 - "Mobile Design System", Community 105 - "SEO Fundamentals" (+235 more)
...
Cohesion: 0.10
Nodes (21): @angular/cli, @angular/compiler-cli, devDependencies, @angular/cli, @angular/compiler-cli, karma-coverage, karma-jasmine, karma-jasmine-html-reporter (+13 more)

### Community 61 - "SessionAuthenticationFilter.java"
Cohesion: 0.31
Nodes (7): SessionAuthenticationFilter, jakarta.servlet.FilterChain, jakarta.servlet.http.HttpServletRequest, jakarta.servlet.http.HttpServletResponse, org.springframework.stereotype.Component, org.springframework.web.filter.OncePerRequestFilter, Override

### Community 62 - "org.springframework.http.ResponseEntity"
Cohesion: 0.23
Nodes (10): AuthController, PostMapping, RequestMapping, RestController, GlobalExceptionHandler, org.springframework.http.HttpStatus, org.springframework.http.ResponseEntity, org.springframework.web.bind.annotation.ExceptionHandler (+2 more)
...
### Community 66 - "lombok.RequiredArgsConstructor"
Cohesion: 0.15
Nodes (16): InventoryService, lombok.extern.slf4j.Slf4j, lombok.RequiredArgsConstructor, OrderService, org.springframework.stereotype.Service, org.springframework.transaction.annotation.Transactional, PaymentService, GetMapping (+8 more)
...
Cohesion: 0.20
Nodes (8): OrderRequest, OrderResponse, OrderService, Injectable, DashboardComponent, Component, OrderListComponent, Component
...
### Community 98 - "order-place.component.ts"
Cohesion: 0.15
Nodes (7): InventoryService, Injectable, InventoryCheckComponent, Component, OrderPlaceComponent, Component, environment
...
### Community 118 - "User"
Cohesion: 0.13
Nodes (14): UserResponse, AllArgsConstructor, Builder, Entity, NoArgsConstructor, Table, User, UserRepository (+6 more)
...
### Community 177 - "frontend-design/SKILL.md"
Cohesion: 0.18
...
### Community 183 - "org.springframework.context.annotation.Bean"
Cohesion: 0.19
Nodes (12): SecurityConfig, Routes, SecurityConfig, org.springframework.context.annotation.Bean, org.springframework.context.annotation.Configuration, org.springframework.security.config.annotation.web.builders.HttpSecurity, org.springframework.security.config.annotation.web.configuration.EnableWebSecurity, org.springframework.security.crypto.password.PasswordEncoder (+4 more)
...
### Community 213 - "2. React Native Performance"
Cohesion: 0.22
...
### Community 214 - "3. Flutter Performance"
Cohesion: 0.22
...
### Community 231 - "4. Animation Performance (Both Platforms)"
Cohesion: 0.40
...
- **What connects `Colors`, `Colors`, `api-gateway` to the rest of the system?**
  _2447 weakly-connected nodes found - possible documentation gaps or missing edges._
